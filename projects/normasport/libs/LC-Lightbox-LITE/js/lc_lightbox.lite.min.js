...
b("#lcl_wrap").length&&b("#lcl_wrap").remove();b("body").append('<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing"><div id="lcl_window"><div id="lcl_corner_close" title="закрыть"></div><div id="lcl_loader" class="lcl_loader_pre_first_el"><span id="lcll_1"></span><span id="lcll_2"></span></div><div id="lcl_nav_cmd"><div class="lcl_icon lcl_prev"></div><div class="lcl_icon lcl_play"></div><div class="lcl_icon lcl_next"></div><div class="lcl_icon lcl_counter"></div><div class="lcl_icon lcl_right_icon lcl_close" title="закрыть"></div><div class="lcl_icon lcl_right_icon lcl_fullscreen" title="полный экран"></div><div class="lcl_icon lcl_right_icon lcl_txt_toggle" title="показать/скрыть текст"></div><div class="lcl_icon lcl_right_icon lcl_download" title="скачать"></div><div class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="показать/скрыть миниатюры"></div><div class="lcl_icon lcl_right_icon lcl_socials" title="toggle socials"></div></div><div id="lcl_contents_wrap"><div id="lcl_subj"><div id="lcl_elem_wrap"></div></div><div id="lcl_txt"></div></div></div><div id="lcl_thumbs_nav"></div><div id="lcl_overlay"></div></div>');
...
d.download+'" target="_blank" download="'+f+'"></a>')}else b(".lcl_download").hide();b(".lcl_counter").html(e+1+" / "+h.elems.length);H(d)&&"unknown"!=d.type?(b("#lcl_wrap").removeClass("lcl_no_txt"),b(".lcl_txt_toggle").show(),d.title&&b("#lcl_txt").append('<h3 id="lcl_title">'+d.title+"</h3>"),d.author&&b("#lcl_txt").append('<h5 id="lcl_author">'+d.author+"</h5>"),d.txt&&b("#lcl_txt").append('<section id="lcl_descr">'+d.txt+"</section>"),d.txt&&(d.title&&d.author?b("#lcl_txt h5").addClass("lcl_txt_border"):
