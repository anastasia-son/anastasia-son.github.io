		...
		function doEllipsis($elem, opts) {
			...
			if ($elem.is(':visible')) {
				...
				function fillElement() {
					...
					if (expandlink) {
						var expandElement = $(document.createElement('a')).addClass('expand-text-link').append('<span>' + expandlink + '</span>');
		...
		function expandSection($elem) {
			...
			if (options.expandLink && $elem.data('collapselink')) {
				var collapselink = $elem.data('collapselink'),
					collapseElement = $(document.createElement('a')).addClass('collapse-text-link').append('<span>' + collapselink + '</span>');
